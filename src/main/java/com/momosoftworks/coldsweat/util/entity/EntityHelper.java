...
{
    private static final MappedCache<Entity, Pair<CompoundNBT, Long>> ENTITY_DATA_CACHE = new MappedCache<>(entity -> Pair.of(entity.saveWithoutId(new CompoundNBT()), System.currentTimeMillis()), e -> e.removed);
