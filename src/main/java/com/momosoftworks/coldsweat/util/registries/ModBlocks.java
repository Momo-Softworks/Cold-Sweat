...
public class ModBlocks
{
    ...
    public static Block ICEBOX_FROSTED;
    ...
    public static void registerBlocks()
    {
        ...
        ICEBOX = namedBlock(new IceboxBlock(false), "icebox").setCreativeTab(ColdSweat.TAB_COLD_SWEAT).setHardness(2.0F).setResistance(5.0F);
        ICEBOX_FROSTED = namedBlock(new IceboxBlock(true), "icebox_frosted").setHardness(2.0F).setResistance(5.0F);
        ...
        GameRegistry.registerBlock(ICEBOX, ICEBOX.getUnlocalizedName());
        GameRegistry.registerBlock(ICEBOX_FROSTED, ICEBOX_FROSTED.getUnlocalizedName());
    }
