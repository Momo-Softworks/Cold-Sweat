...
public class ModItems
{
    ...
    public static final Item FUR = ItemInit.GOAT_FUR.get();
    ...
    public static final Item HOGLIN_HELMET = ItemInit.HOGLIN_HELMET.get();
    public static final Item HOGLIN_CHESTPLATE = ItemInit.HOGLIN_CHESTPLATE.get();
    public static final Item HOGLIN_LEGGINGS = ItemInit.HOGLIN_LEGGINGS.get();
    public static final Item HOGLIN_BOOTS = ItemInit.HOGLIN_BOOTS.get();
    public static final Item GOAT_FUR_HELMET = ItemInit.GOAT_FUR_HELMET.get();
    public static final Item GOAT_FUR_CHESTPLATE = ItemInit.GOAT_FUR_CHESTPLATE.get();
    public static final Item GOAT_FUR_LEGGINGS = ItemInit.GOAT_FUR_LEGGINGS.get();
