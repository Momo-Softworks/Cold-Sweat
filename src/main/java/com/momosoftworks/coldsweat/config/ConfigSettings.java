...
public class ConfigSettings
{
    ...
    private static <K, V> void putRegistryEntries(Multimap<K, V> map, Registry<K> registry, Optional<List<Either<TagKey<K>, K>>> list, V data)
    {
        RegistryHelper.mapBuiltinRegistryTagList(registry, CSMath.listOrEmpty(list)).forEach(entry -> map.put(entry, data));
    }
