    ...
    static
    {
        ...
        (fuelType, configValue, holder) ->
        {
            ...
            for (List<?> list : configValue.get())
            {
                ...
                putRegistryEntries(dataMap, BuiltInRegistries.ITEM, data.item().flatListMap(ItemRequirement::items), data);
            }
        ...
        INSULATED_MOUNTS = addSetting("insulated_entities", RegistryMultiMap::new, holder ->
        {
            ...
            for (List<?> list : EntitySettingsConfig.INSULATED_MOUNTS.get())
            {
                ...
                putRegistryEntries(dataMap, BuiltInRegistries.ENTITY_TYPE, data.entity().flatListMap(EntityRequirement::entities), data);
            }
            // Handle registry removals
