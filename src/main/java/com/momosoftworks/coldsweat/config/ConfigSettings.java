...
public class ConfigSettings
{
    ...
    static
    {
        ...
        (encoder) -> ConfigHelper.serializeRegistry(encoder, "TempAffectedEntities", Registries.ENTITY_TYPE, ModRegistries.ENTITY_CLIMATE_DATA, item -> BuiltInRegistries.ENTITY_TYPE.getKey(item)),
