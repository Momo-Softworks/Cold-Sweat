...
public class ConfigSettings
{
    ...
    static
    {
        ...
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "InsulationSlotOverrides", Registries.ITEM, ModRegistries.INSULATION_SLOTS_DATA, item -> ForgeRegistries.ITEMS.getKey(item)),
        ...
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "TempAffectedEntities", Registries.ENTITY_TYPE, ModRegistries.ENTITY_CLIMATE_DATA, item -> ForgeRegistries.ENTITY_TYPES.getKey(item)),
        ...
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "TempEffects", Registries.ENTITY_TYPE, ModRegistries.TEMP_EFFECTS_DATA, item -> ForgeRegistries.ENTITY_TYPES.getKey(item)),
