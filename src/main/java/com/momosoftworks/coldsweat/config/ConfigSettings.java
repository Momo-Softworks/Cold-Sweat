...
public class ConfigSettings
{
    ...
    public static <T> DynamicHolder<T> addSyncedSetting(String id, T defaultVal, Consumer<DynamicHolder<T>> loader, Function<T, CompoundNBT> writer, Function<CompoundNBT, T> reader, Consumer<T> saver)
