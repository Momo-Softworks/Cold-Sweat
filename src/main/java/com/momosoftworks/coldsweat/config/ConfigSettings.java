...
public class ConfigSettings
{
    ...
    static
    {
        ...
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "InsulationSlotOverrides", Registries.ITEM, ModRegistries.INSULATION_SLOTS_DATA, item -> BuiltInRegistries.ITEM.getKey(item)),
        (decoder) -> ConfigHelper.deserializeMultimapRegistry(decoder, "InsulationSlotOverrides", ModRegistries.INSULATION_SLOTS_DATA, rl -> BuiltInRegistries.ITEM.get(rl)),
        (saver) -> {},
        SyncType.ONE_WAY);
        ...
        (encoder) -> ConfigHelper.serializeBuiltinRegistryList(encoder, "SleepCheckOverrideBlocks", BuiltInRegistries.BLOCK),
        (decoder) -> ConfigHelper.deserializeBuiltinRegistryList(decoder, "SleepCheckOverrideBlocks", BuiltInRegistries.BLOCK),
        (saver) -> {},
        SyncType.ONE_WAY);
        ...
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "TempAffectedEntities", Registries.ENTITY_TYPE, ModRegistries.ENTITY_CLIMATE_DATA, item -> BuiltInRegistries.ENTITY_TYPE.getKey(item)),
        (decoder) -> ConfigHelper.deserializeMultimapRegistry(decoder, "TempAffectedEntities", ModRegistries.ENTITY_CLIMATE_DATA, rl -> BuiltInRegistries.ENTITY_TYPE.get(rl)),
        (saver) -> {},
        SyncType.ONE_WAY);

        ENTITY_TEMP_EFFECTS = addSyncedSetting("temp_effects", RegistryMultiMap::new, holder -> {},
        (encoder) -> ConfigHelper.serializeMultimapRegistry(encoder, "TempEffects", Registries.ENTITY_TYPE, ModRegistries.TEMP_EFFECTS_DATA, item -> BuiltInRegistries.ENTITY_TYPE.getKey(item)),
        (decoder) -> ConfigHelper.deserializeMultimapRegistry(decoder, "TempEffects", ModRegistries.TEMP_EFFECTS_DATA, rl -> BuiltInRegistries.ENTITY_TYPE.get(rl)),
        (saver) -> {},
        SyncType.ONE_WAY);
        ...
        (encoder) -> ConfigHelper.serializeBuiltinRegistryList(encoder, "HearthWhitelist", BuiltInRegistries.BLOCK),
        (decoder) -> ConfigHelper.deserializeBuiltinRegistryList(decoder, "HearthWhitelist", BuiltInRegistries.BLOCK),
        saver -> {},
        SyncType.ONE_WAY);
        ...
        (encoder) -> ConfigHelper.serializeBuiltinRegistryList(encoder, "HearthBlacklist", BuiltInRegistries.BLOCK),
        (decoder) -> ConfigHelper.deserializeBuiltinRegistryList(decoder, "HearthBlacklist", BuiltInRegistries.BLOCK),
        saver -> {},
        SyncType.ONE_WAY);
