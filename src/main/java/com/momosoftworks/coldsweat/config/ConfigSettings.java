...
public class ConfigSettings
{
    ...
    static
    {
        ...
        BODY_ICON_POS = addClientSetting("body_icon_pos", Vector2i::new, holder -> holder.set(new Vector2i(ClientSettingsConfig.getInstance().getBodyIconX(),
        ...
        BODY_READOUT_POS = addClientSetting("body_readout_pos", Vector2i::new, holder -> holder.set(new Vector2i(ClientSettingsConfig.getInstance().getBodyReadoutX(),
        ...
        WORLD_GAUGE_POS = addClientSetting("world_gauge_pos", Vector2i::new, holder -> holder.set(new Vector2i(ClientSettingsConfig.getInstance().getWorldGaugeX(),
        ...
        CONFIG_BUTTON_POS = addClientSetting("config_button_pos", Vector2i::new, holder -> holder.set(new Vector2i(ClientSettingsConfig.getInstance().getConfigButtonPos().get(0),
