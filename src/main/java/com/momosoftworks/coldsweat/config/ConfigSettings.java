...
public class ConfigSettings
{
    ...
    static
    {
        ...
        (encoder) -> ConfigHelper.serializeRegistry(encoder, "TempAffectedEntities", Registries.ENTITY_TYPE, ModRegistries.ENTITY_CLIMATE_DATA, item -> ForgeRegistries.ENTITY_TYPES.getKey(item)),
