...
public class ValueHolder<T>
{
    ...
    private Function<T, NBTTagCompound> encoder;
    private Function<NBTTagCompound, T> decoder;
     ...
     * @param <V> The type of the value.
     */
    public static <V> ValueHolder<V> synced(Supplier<V> valueCreator, Function<V, NBTTagCompound> encoder, Function<NBTTagCompound, V> decoder, Consumer<V> saver)
    {
