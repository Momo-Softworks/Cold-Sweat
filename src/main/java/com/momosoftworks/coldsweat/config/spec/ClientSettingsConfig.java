...
public class ClientSettingsConfig
{
    ...
    {   BODY_TEMP_ICON_POS.set(Arrays.asList(pos, getBodyIconY()));
    }
    public void setBodyIconY(int pos)
    {   BODY_TEMP_ICON_POS.set(Arrays.asList(getBodyIconX(), pos));
    }

    public void setBodyReadoutX(int pos)
    {   BODY_TEMP_READOUT_POS.set(Arrays.asList(pos, getBodyReadoutY()));
    }
    public void setBodyReadoutY(int pos)
    {   BODY_TEMP_READOUT_POS.set(Arrays.asList(getBodyReadoutX(), pos));
    }

    public void setWorldGaugeX(int pos)
    {   WORLD_TEMP_GAUGE_POS.set(Arrays.asList(pos, getWorldGaugeY()));
    }
    public void setWorldGaugeY(int pos)
    {   WORLD_TEMP_GAUGE_POS.set(Arrays.asList(getWorldGaugeX(), pos));
    }
    ...
    {   SHOW_SCREEN_DISTORTIONS.set(sway);
    }
