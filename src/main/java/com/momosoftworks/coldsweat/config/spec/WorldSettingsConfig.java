...
public class WorldSettingsConfig
{
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> BIOME_TEMP_OFFSETS;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> BIOME_TEMPERATURES;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> DIMENSION_TEMP_OFFSETS;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> DIMENSION_TEMPERATURES;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> STRUCTURE_TEMP_OFFSETS;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> STRUCTURE_TEMPERATURES;
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> IS_SOUL_FIRE_COLD;

    public static ModConfigSpec.ConfigValue<List<?>> SUMMER_TEMPERATURES;
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> ENABLE_SMART_ICEBOX;
    public static final ModConfigSpec.ConfigValue<Double> SOURCE_EFFECT_STRENGTH;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SOURCE_SPREAD_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SOURCE_SPREAD_BLACKLIST;

    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_MAX_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_MAX_VOLUME;
    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_WARM_UP_TIME;
    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_MAX_INSULATION;
    public static final ModConfigSpec.ConfigValue<Integer> HEARTH_FUEL_INTERVAL;

    public static final ModConfigSpec.ConfigValue<Integer> BOILER_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> BOILER_MAX_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> BOILER_MAX_VOLUME;
    public static final ModConfigSpec.ConfigValue<Integer> BOILER_WARM_UP_TIME;
    public static final ModConfigSpec.ConfigValue<Integer> BOILER_MAX_INSULATION;
    public static final ModConfigSpec.ConfigValue<Integer> BOILER_FUEL_INTERVAL;

    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_MAX_RANGE;
    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_MAX_VOLUME;
    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_WARM_UP_TIME;
    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_MAX_INSULATION;
    public static final ModConfigSpec.ConfigValue<Integer> ICEBOX_FUEL_INTERVAL;
    ...
    static
    {
        ...
        BLOCK_TEMPERATURES = BUILDER
                .comment(" Format:",
                         ...
                         " units: \"f\" (Fahrenheit), \"c\" (Celsius), \"mc\" (Minecraft units)",
                         " *max effect: The maximum cumulative temperature change this block can cause to a player (even with multiple blocks)",
                ...
                .defineListAllowEmpty(List.of("Block Temperatures"), () -> List.of(
                                            ...
                                            List.of("#minecraft:campfires,!minecraft:soul_campfire", 0.476, 7, "mc", 0.9, "lit=true", " ", 8),
    ...
    private static List<?> getSeasonalTemperature(ModConfigSpec.ConfigValue<List<?>> setting)
    {
