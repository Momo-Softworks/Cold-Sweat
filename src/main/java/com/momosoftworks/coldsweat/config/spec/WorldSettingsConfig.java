...
public class WorldSettingsConfig
{
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> BIOME_TEMP_OVERRIDES;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> DIMENSION_TEMP_OFFSETS;
    public static final ModConfigSpec.ConfigValue<List<? extends List<?>>> DIMENSION_TEMP_OVERRIDES;
    ...
    public static ModConfigSpec.ConfigValue<List<? extends Number>> SUMMER_TEMPERATURES;
    public static ModConfigSpec.ConfigValue<List<? extends Number>> AUTUMN_TEMPERATURES;
    public static ModConfigSpec.ConfigValue<List<? extends Number>> WINTER_TEMPERATURES;
    public static ModConfigSpec.ConfigValue<List<? extends Number>> SPRING_TEMPERATURES;

    public static final ModConfigSpec.ConfigValue<Boolean> ENABLE_SMART_HEARTH;
    public static final ModConfigSpec.ConfigValue<Double> HEARTH_INSULATION_STRENGTH;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> HEARTH_SPREAD_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> HEARTH_SPREAD_BLACKLIST;
