    ...
    static
    {
        ...
        BIOME_TEMPERATURES = BUILDER
            ...
            .defineListAllowEmpty(Arrays.asList("Biome Temperatures"), () -> ListBuilder.begin(
                            ...
                            Arrays.asList("minecraft:snowy_taiga", 8, 38, "F", -15),
                            Arrays.asList("minecraft:desert", 48, 115, "F"),
                            Arrays.asList("minecraft:stone_shore", 50, 64, "F"),
                            Arrays.asList("minecraft:snowy_beach", 8, 38, "F", -15),
                            Arrays.asList("minecraft:warm_ocean", 67, 76, "F", 5),
                            Arrays.asList("minecraft:frozen_ocean", 20, 31, "F", -20),
                            Arrays.asList("minecraft:deep_frozen_ocean", 20, 31, "F", -20),
