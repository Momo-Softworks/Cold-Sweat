    ...
    static
    {
        ...
        BIOME_TEMPERATURES = BUILDER
            ...
            .defineListAllowEmpty(List.of("Biome Temperatures"), () -> ListBuilder.begin(
                            ...
                            List.of("minecraft:snowy_beach", 8, 30, "F", -15),
                            ...
                            List.of("minecraft:frozen_river", 8, 31, "F", -25),
                            List.of("minecraft:frozen_ocean", 20, 31, "F", -25),
                     ...
                     .addIf(CompatManager.isBiomesOPlentyLoaded(),
                            ...
                            () -> List.of("biomesoplenty:tundra", 8, 30, "F", -15),
