...
public class MainSettingsConfig
{
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> TEMPERATURE_HURT_INTERVAL;
    ...
    static 
    {
        ...
        DIFFICULTY = BUILDER
                ...
                .define(Arrays.asList("Difficulty"), () -> defaultDiff.getId(),
        ...
        VERSION = BUILDER
                ...
                .define(Arrays.asList("Version"), () -> ColdSweat.getVersion(), obj -> obj instanceof String, String.class);
        ...
        BUILDER.push("Temperature Effects");
            ...
            MIN_ACCLIMATION_RANGE = BUILDER
                ...
                .defineList(Arrays.asList("Min Acclimation Range"), () -> Arrays.asList(-0.46, 0.23), o -> o instanceof Number);
            ...
            MAX_ACCLIMATION_RANGE = BUILDER
                ...
                .defineList(Arrays.asList("Max Acclimation Range"), () -> Arrays.asList(-0.23, 0.46), o -> o instanceof Number);
