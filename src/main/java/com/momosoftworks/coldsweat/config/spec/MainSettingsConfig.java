...
public class MainSettingsConfig
{
    ...
    public static final ModConfigSpec.ConfigValue<String> DIFFICULTY;
    public static final ModConfigSpec.ConfigValue<String> VERSION;
    public static final ModConfigSpec.ConfigValue<Boolean> AUTO_UPDATE;
    ...
    public static final ModConfigSpec.DoubleValue MODIFIER_TICK_RATE;
    public static final ModConfigSpec.DoubleValue DRYOFF_SPEED;

    public static final ModConfigSpec.ConfigValue<Double> ACCLIMATION_SPEED;
    public static final ModConfigSpec.ConfigValue<List<? extends Number>> MIN_ACCLIMATION_RANGE;
    public static final ModConfigSpec.ConfigValue<List<? extends Number>> MAX_ACCLIMATION_RANGE;
    ...
    static 
    {
        ...
        BUILDER.push("Temperature Effects");
            ...
            MIN_ACCLIMATION_RANGE = BUILDER
                ...
                .defineListAllowEmpty("Min Acclimation Range", List.of(-0.46, 0.23), o -> o instanceof Number);
            ...
            MAX_ACCLIMATION_RANGE = BUILDER
                ...
                .defineListAllowEmpty("Max Acclimation Range", List.of(-0.23, 0.46), o -> o instanceof Number);
