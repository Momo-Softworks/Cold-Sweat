...
{
    public static final DeferredRegister<TempEffectType<?>> REGISTRY_REGISTER = DeferredRegister.create(new ResourceLocation(ColdSweat.MOD_ID, "temp_effect"), ColdSweat.MOD_ID);
    public static final Supplier<IForgeRegistry<TempEffectType<?>>> TEMP_EFFECTS_REGISTRY = REGISTRY_REGISTER.makeRegistry((Class<TempEffectType<?>>) (Class) TempEffectType.class, RegistryBuilder::new);
