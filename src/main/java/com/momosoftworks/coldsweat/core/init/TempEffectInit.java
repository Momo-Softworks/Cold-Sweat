...
public class TempEffectInit
{
    ...
    public static final Supplier<IForgeRegistry<TempEffectType<?>>> TEMP_EFFECTS_REGISTRY = TEMP_EFFECTS.makeRegistry((Class<TempEffectType<?>>) (Class) TempEffectType.class, RegistryBuilder::new);
