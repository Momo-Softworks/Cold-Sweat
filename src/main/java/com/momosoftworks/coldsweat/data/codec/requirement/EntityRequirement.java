                                ...
                                Optional<Predicate<Entity>> predicate)
{
    ...
    private static final Codec<Either<TagKey<EntityType<?>>, EntityType<?>>> ENTITY_CODEC = Codec.either(ConfigHelper.tagOrBuiltinCodec(Registry.ENTITY_TYPE_REGISTRY, ForgeRegistries.ENTITIES), Codec.STRING).xmap(
        itemOrString -> {
