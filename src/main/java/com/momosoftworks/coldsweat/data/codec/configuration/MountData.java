...
public class MountData extends ConfigData implements RequirementHolder
{
    ...
    {   return coldInsulation.get(CSMath.mapOf("entity", entity, "rider", rider));
    }
    public ValueGetter<Double> heatInsulation()
    {   return heatInsulation;
    }
    public double heatInsulation(Entity entity, Entity rider)
    {   return heatInsulation.get(CSMath.mapOf("entity", entity, "rider", rider));
    }
    ...
    public Map<ResourceLocation, Double> modifierImmunities(Entity entity, Entity rider)
    {
        ...
        {   result.put(entry.getKey(), entry.getValue().get(CSMath.mapOf("entity", entity, "rider", rider)));
        }
        return result;
    }
