...
public class EntityTempData extends ConfigData implements RequirementHolder
{
    ...
    {
        this(entity, temperature, range, units, otherEntityRequirement, maxEffect, affectsSelf, ConfigHelper.getModIDs(CSMath.listOrEmpty(entity.entities()), ForgeRegistries.ENTITY_TYPES));
    }
