...
public class EntityTempData extends ConfigData implements RequirementHolder
{
    ...
    {   return Temperature.convert(temperature.get(CSMath.mapOf("entity", entity, "target", affectedEntity)), this.units, Temperature.Units.MC, false);
    }
    public double getMaxEffect(Entity entity, Entity affectedEntity)
    {   return Temperature.convert(maxEffect.get(CSMath.mapOf("entity", entity, "target", affectedEntity)), this.units, Temperature.Units.MC, false);
    }
    public double getMaxTemp(Entity entity, Entity affectedEntity)
    {   return Temperature.convert(maxTemp.get(CSMath.mapOf("entity", entity, "target", affectedEntity)), this.units, Temperature.Units.MC, true);
    }
    public double getMinTemp(Entity entity, Entity affectedEntity)
    {   return Temperature.convert(minTemp.get(CSMath.mapOf("entity", entity, "target", affectedEntity)), this.units, Temperature.Units.MC, true);
    }
