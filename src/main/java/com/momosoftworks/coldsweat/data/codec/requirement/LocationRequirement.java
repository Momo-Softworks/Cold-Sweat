                                  ...
                                  Optional<Predicate<BlockInWorld>> predicate)
{
    public static final Codec<LocationRequirement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            NegatableList.codec(ConfigHelper.tagOrResourceKeyCodec(Registry.BIOME_REGISTRY)).optionalFieldOf("biome", new NegatableList<>()).forGetter(location -> location.biome),
            NegatableList.codec(ConfigHelper.tagOrResourceKeyCodec(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY)).optionalFieldOf("structure", new NegatableList<>()).forGetter(location -> location.structure),
            NegatableList.codec(ConfigHelper.tagOrResourceKeyCodec(Registry.DIMENSION_REGISTRY)).optionalFieldOf("dimension", new NegatableList<>()).forGetter(location -> location.dimension),
