                                  ...
                                  Optional<FluidRequirement> fluid)
{
    ...
    public static LocationRequirement deserialize(CompoundTag tag)
    {
        ...
        Optional<Either<TagKey<Biome>, ResourceKey<Biome>>> biome = tag.contains("biome")
                                                                    ...
                                                                    : Optional.empty();
        Optional<Either<TagKey<ConfiguredStructureFeature<?, ?>>, ResourceKey<ConfiguredStructureFeature<?, ?>>>> structure = tag.contains("structure")
                                                                                ? Optional.of(ConfigHelper.deserializeTagOrResourceKey(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, tag.getString("structure")))
                                                                                : Optional.empty();
