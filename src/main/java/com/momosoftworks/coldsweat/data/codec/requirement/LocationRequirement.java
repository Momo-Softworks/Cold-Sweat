                                  ...
                                  Optional<FluidRequirement> fluid)
{
    public static final Codec<LocationRequirement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceKey.codec(Registry.STRUCTURE_REGISTRY).optionalFieldOf("structure").forGetter(location -> location.structure),
    ...
    public static LocationRequirement deserialize(CompoundTag tag)
    {
        ...
        Optional<ResourceKey<Structure>> structure = tag.contains("structure") ? Optional.of(ResourceKey.create(Registry.STRUCTURE_REGISTRY, new ResourceLocation(tag.getString("structure"))) ) : Optional.empty();
