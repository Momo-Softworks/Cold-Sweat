                                  ...
                                  Optional<Predicate<BlockInWorld>> predicate)
{
    public static final Codec<LocationRequirement> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            NegatableList.listCodec(ConfigHelper.tagOrResourceKeyCodec(Registry.STRUCTURE_REGISTRY)).optionalFieldOf("structure", new NegatableList<>()).forGetter(location -> location.structure),
