...
public class ItemTempData extends ConfigData implements RequirementHolder
{
    ...
    {   return maxEffect.get(CSMath.mapOf("item", stack, "entity", entity));
    }
    public ValueGetter<Double> maxTemp()
    {   return maxTemp;
    }
    public double maxTemp(ItemStack stack, Entity entity)
    {   return maxTemp.get(CSMath.mapOf("item", stack, "entity", entity));
    }
    public ValueGetter<Double> minTemp()
    {   return minTemp;
    }
    public double minTemp(ItemStack stack, Entity entity)
    {   return minTemp.get(CSMath.mapOf("item", stack, "entity", entity));
    }
    ...
    public Map<ResourceLocation, Double> immuneTempModifiers(ItemStack stack, Entity entity)
    {
        ...
        {   result.put(entry.getKey(), entry.getValue().get(CSMath.mapOf("item", stack, "entity", entity)));
        }
        return result;
    }
    ...
    {   return hideIfUnmet.get(CSMath.mapOf("item", stack, "entity", entity));
    }
