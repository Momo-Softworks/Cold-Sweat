...
public class ModRegistries
{
    ...
    // Special registries
    public static final RegistryHolder<RemoveRegistryData<?>> REMOVE_REGISTRY_DATA = createRegistry(new ResourceLocation(ColdSweat.MOD_ID, "remove"), RemoveRegistryData.CODEC, null);
