...
public class ModRegistries
{
    ...
    public static final ResourceKey<Registry<EntityTempData>> ENTITY_TEMP_DATA = ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(ColdSweat.MOD_ID, "entity/entity_temp"));
}
