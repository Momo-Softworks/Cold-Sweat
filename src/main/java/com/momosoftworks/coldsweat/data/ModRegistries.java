...
public class ModRegistries
{
    ...
    public static final ResourceKey<Registry<DepthTempData>> DEPTH_TEMP_DATA = ResourceKey.createRegistryKey(new ResourceLocation(ColdSweat.MOD_ID, "world/depth_temp"));
