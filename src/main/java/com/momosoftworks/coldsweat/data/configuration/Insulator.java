...
public record Insulator(Optional<ResourceLocation> itemId, Optional<TagKey<Item>> itemTag, InsulationType type, Insulation insulation)
{
    public static final Codec<Insulator> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            TagKey.codec(Registries.ITEM).optionalFieldOf("tag").forGetter(Insulator::itemTag),
