...
public record InsulatingMount(EntityType<?> entityType, double coldInsulation, double heatInsulation, EntityRequirement requirement) implements NbtSerializable
{
    ...
    public CompoundTag serialize()
    {
        ...
        tag.putString("entity", ForgeRegistries.ENTITY_TYPES.getKey(entityType).toString());
    ...
    {
        return new InsulatingMount(ForgeRegistries.ENTITY_TYPES.getValue(ResourceLocation.tryParse(tag.getString("entity"))),
