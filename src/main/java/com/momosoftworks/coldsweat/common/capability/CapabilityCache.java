...
public class CapabilityCache<C, K extends IAttachmentHolder> extends MappedCache<K, Optional<C>>
{
    ...
    {
        super(e -> e.getExistingData(capability), invalidator);
        this.capability = capability;
    }

    public CapabilityCache(Supplier<AttachmentType<C>> capability)
    {
        super(e -> e.getExistingData(capability));
        this.capability = capability;
    }
}
