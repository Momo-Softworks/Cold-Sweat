...
public class TempModifierArgument implements ArgumentType<ResourceLocation>
{
    ...
    public static ResourceLocation getModifier(CommandContext<CommandSource> context, String argument)
    ...
    public static class Serializer implements IArgumentSerializer<TempModifierArgument>
    {
        @Override
        public void serializeToNetwork(TempModifierArgument template, PacketBuffer buffer)
        {
        }

        @Override
        public TempModifierArgument deserializeFromNetwork(PacketBuffer buffer)
        {   return new TempModifierArgument();
        }

        @Override
        public void serializeToJson(TempModifierArgument argument, JsonObject json)
        {
        }
    }
}
