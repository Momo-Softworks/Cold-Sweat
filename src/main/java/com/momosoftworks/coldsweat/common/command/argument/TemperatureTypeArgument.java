...
{
    private static final Codec<Temperature.Type> TEMPERATURES_CODEC = StringRepresentable.fromEnumWithMapping(() -> EntityTempManager.VALID_TEMPERATURE_TYPES, (p_275334_) ->
