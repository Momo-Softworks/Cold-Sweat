...
public abstract class TempModifier
{
     ...
     */
    protected abstract Function<Double, Double> calculate(EntityLivingBase entity, Temperature.Type type);

    /**
     * Posts this TempModifier's {@link #calculate(EntityLivingBase, com.momosoftworks.coldsweat.api.util.Temperature.Type)} to the Forge event bus.<br>
     * Returns the stored value if this TempModifier has a tickRate set, and it is not the right tick.<br>
     * <br>
     * @param temp the Temperature being fed into the {@link #calculate(EntityLivingBase, com.momosoftworks.coldsweat.api.util.Temperature.Type)} method.
    ...
    /**
     * TempModifiers can be configured to run {@link TempModifier#calculate(EntityLivingBase, com.momosoftworks.coldsweat.api.util.Temperature.Type)} at a specified interval.<br>
