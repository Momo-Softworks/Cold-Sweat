...
public class Temperature
{
    ...
    {   return EntityTempManager.TEMP_MODIFIER_IMMUNITIES.getOrDefault(entity, Collections.emptyMap()).getOrDefault(modifier.getID(), 0.0);
    }
    ...
    public enum Trait implements StringRepresentable
    {
        ...
        {   return new TranslationTextComponent("trait.cold_sweat." + this.getSerializedName()).getString();
        }
    }
