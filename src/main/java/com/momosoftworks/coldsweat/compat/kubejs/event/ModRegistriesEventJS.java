...
public class ModRegistriesEventJS extends StartupEventJS
{
    ...
    public void addInsulator(Consumer<InsulatorBuilderJS> builder)
    {
        ...
        for (Item item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ITEMS, insulatorJS.itemPredicate.flatListMap(ItemRequirement::items)))
    ...
    public void addFoodTemperature(Consumer<FoodBuilderJS> builder)
    {
        ...
        for (Item item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ITEMS, foodJS.itemPredicate.flatListMap(ItemRequirement::items)))
    ...
    private void addFuel(Consumer<FuelBuilderJS> builder, DynamicHolder<Multimap<Item, FuelData>> config, FuelData.FuelType fuelType)
    {
        ...
        for (Item item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ITEMS, fuelJS.itemPredicate.flatListMap(ItemRequirement::items)))
    ...
    public void addCarriedItemTemperature(Consumer<CarriedItemBuilderJS> builder)
    {
        ...
        for (Item item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ITEMS, carriedItemJS.itemPredicate.flatListMap(ItemRequirement::items)))
    ...
    public void addDryingItem(Consumer<DryingItemBuilderJS> builder)
    {
        ...
        for (Item item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ITEMS, dryingItemJS.itemPredicate.flatListMap(ItemRequirement::items)))
    ...
    public void addEntityTemperature(Consumer<EntityTempBuilderJS> builder)
    {
        ...
        for (EntityType<?> item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ENTITIES, entityTempJS.entityPredicate.flatListMap(EntityRequirement::entities)))
    ...
    public void addEntityClimate(Consumer<EntityClimateBuilderJS> builder)
    {
        ...
        for (EntityType<?> item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ENTITIES, entityClimateJS.entityPredicate.flatListMap(EntityRequirement::entities)))
    ...
    public void addInsulatingMount(Consumer<InsulatingMountBuilderJS> builder)
    {
        ...
        for (EntityType<?> item : RegistryHelper.mapForgeRegistryTagList(ForgeRegistries.ENTITIES, insulatingMountJS.entityPredicate.flatListMap(EntityRequirement::entities)))
