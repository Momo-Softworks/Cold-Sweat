...
public class ModRegistriesEventJS extends StartupEventJS
{
    ...
    public void addInsulator(Consumer<InsulatorBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.INSULATOR_DATA, Holder.direct(insulator));
    }
    ...
    public void addFoodTemperature(Consumer<FoodBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.FOOD_DATA, Holder.direct(foodData));
    }
    ...
    private void addFuel(Consumer<FuelBuilderJS> builder, FuelData.FuelType fuelType)
    {
        ...
        this.event.addRegistry(ModRegistries.FUEL_DATA, Holder.direct(fuelData));
    }
    ...
    public void addCarriedItemTemperature(Consumer<CarriedItemBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.CARRY_TEMP_DATA, Holder.direct(carryData));
    }
    ...
    public void addDryingItem(Consumer<DryingItemBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.DRYING_ITEM_DATA, Holder.direct(dryingData));
    }
    ...
    private <K, V extends ConfigData> void addRegistryConfig(ResourceKey<Registry<K>> keyRegistry,
                                                             ...
                                                             String[] rawKeys,
                                                             Function<NegatableList<Either<TagKey<K>, Holder<K>>>, V> constructor)
    {
        NegatableList<Either<TagKey<K>, Holder<K>>> parsed = ConfigHelper.parseRegistryItems(keyRegistry, this.event.getRegistryAccess(), rawKeys);
        if (parsed.isEmpty())
        ...
        this.event.addRegistry(modRegistry, Holder.direct(configData));
    }
    ...
    {
        this.addRegistryConfig(Registry.STRUCTURE_REGISTRY, ModRegistries.STRUCTURE_TEMP_DATA, structures,
    ...
    public void addEntityTemperature(Consumer<EntityTempBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.ENTITY_TEMP_DATA, Holder.direct(entityTempData));
    }
    ...
    public void addEntityClimate(Consumer<EntityClimateBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.ENTITY_CLIMATE_DATA, Holder.direct(entityClimateData));
    }
    ...
    public void addInsulatingMount(Consumer<InsulatingMountBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.MOUNT_DATA, Holder.direct(mountData));
    }
    ...
    public void addSpawnBiomes(Consumer<SpawnBiomeBuilderJS> builder)
    {
        ...
        this.event.addRegistry(ModRegistries.ENTITY_SPAWN_BIOME_DATA, Holder.direct(spawnBiomeData));
    }
