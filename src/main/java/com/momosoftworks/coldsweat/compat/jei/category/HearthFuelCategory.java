...
public class HearthFuelCategory extends ColdSweatFuelCategory
{
    ...
    {   super(guiHelper, ModItems.HEARTH.toStack());
    }
    ...
    {   return Component.translatable("jei.cold_sweat.category.hearth_fuel");
    }

    @Override
    protected HearthBlockEntity getDummyBlockEntity()
    {   return new HearthBlockEntity(BlockPos.ZERO, ModBlocks.HEARTH_BOTTOM.value().defaultBlockState());
    }
