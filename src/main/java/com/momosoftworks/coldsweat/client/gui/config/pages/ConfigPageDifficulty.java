...
public class ConfigPageDifficulty extends Screen
{
    ...
    {
        super(new TranslatableComponent("cold_sweat.config.section.difficulty"));
    ...
    {
        return List.of(
                new TranslatableComponent("cold_sweat.config.difficulty.description.min_temp", getTemperatureString(difficulty.getSetting(ColdSweat.createKey("min_temp")), BLUE)),
                new TranslatableComponent("cold_sweat.config.difficulty.description.max_temp", getTemperatureString(difficulty.getSetting(ColdSweat.createKey("max_temp")), RED)),
                getRateComponent(difficulty),
                new TranslatableComponent("cold_sweat.config.difficulty.description.world_temp_" + (difficulty.getSetting(ColdSweat.createKey("require_thermometer")) ? "off" : "on"), BOLD + U_LINE, CLEAR),
                new TranslatableComponent("cold_sweat.config.difficulty.description.potions_" + (difficulty.getSetting(ColdSweat.createKey("ice_resistance_enabled")) ? "on" : "off"), BOLD + U_LINE, CLEAR));
    }
    ...
    public void render(@Nonnull PoseStack poseStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        // Draw Slider Head
        this.blit(poseStack, this.width / 2 - 78 + (difficulty.ordinal() * 37), this.height / 2 - 58,
