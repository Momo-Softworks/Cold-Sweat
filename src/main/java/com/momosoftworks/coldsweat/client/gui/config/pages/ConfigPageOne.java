...
public class ConfigPageOne extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        */
        ...
        // Celsius
        this.addButton("units", Side.LEFT, () -> new TranslatableComponent("cold_sweat.config.units.name").append(": ").append(ConfigSettings.UNITS.get().getFullName()),
        button ->
        {
        ...
        // Temp Hurt Interval
        this.addDecimalInput("temp_damage", Side.LEFT, new TranslatableComponent("cold_sweat.config.temp_damage_interval.name"),
                ...
                true, true, false, new TranslatableComponent("cold_sweat.config.temp_damage_interval.desc"));
        ...
        // Temp Effects Button...
        this.addButton("temp_effects", Side.RIGHT, () -> new TranslatableComponent("cold_sweat.config.temp_effects.name"),
                button -> MINECRAFT.setScreen(new ConfigPageTempEffects(this)),
                true, false, false, new TranslatableComponent("cold_sweat.config.temp_effects.desc"));
