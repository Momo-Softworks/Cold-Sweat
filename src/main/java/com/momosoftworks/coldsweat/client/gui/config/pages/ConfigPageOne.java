...
public class ConfigPageOne extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        */
        ...
        // Celsius
        this.addButton("units", Side.LEFT, () -> new TranslationTextComponent("cold_sweat.config.units.name").append(clientConfig.isCelsius()
        ...
        this.addDecimalInput("temp_damage", Side.LEFT, new TranslationTextComponent("cold_sweat.config.temp_damage.name"),
                ...
                true, false, false, new TranslationTextComponent("cold_sweat.config.temp_damage.desc"));
        ...
        this.addDecimalInput("rate", Side.LEFT, new TranslationTextComponent("cold_sweat.config.temperature_rate.name"),
                ...
                true, false, false, new TranslationTextComponent("cold_sweat.config.temperature_rate.desc"));
