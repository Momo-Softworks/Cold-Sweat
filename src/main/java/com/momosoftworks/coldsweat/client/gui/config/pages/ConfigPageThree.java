...
public class ConfigPageThree extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        this.addSliderButton("water_droplet_opacity", Side.LEFT,
                             () -> getSliderPercentageText(new TranslationTextComponent("cold_sweat.config.water_droplet_opacity.name"), ConfigSettings.WATER_DROPLET_OPACITY.get(), 0),
                             0, 1,
                             ...
                             false, true, new TranslationTextComponent("cold_sweat.config.water_droplet_opacity.desc"));
        ...
        this.addButton("animate_soulspring_lamp", Side.LEFT,
                       ...
                       button ->
                       {
                           ...
                           if (!setting.get())
                           {    ItemPropertiesRegistry.register(ModItems.SOULSPRING_LAMP, new ResourceLocation(ColdSweat.MOD_ID, "soulspring_state"), RegisterItemOverrides.SOULSPRING_LAMP_PROPERTIES);
                           }
        ...
        // Grace Period Length
        this.addDecimalInput("grace_length", Side.RIGHT, new TranslationTextComponent("cold_sweat.config.grace_period_length.name"),
        ...
        // Insulation Strength
        this.addDecimalInput("insulation_strength", Side.RIGHT, new TranslationTextComponent("cold_sweat.config.insulation_strength.name"),
