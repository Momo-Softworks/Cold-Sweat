...
public class ConfigPageThree extends AbstractConfigPage
{
    ...
    protected void init()
    {
        ...
        this.addButton("grace_toggle", Side.LEFT,
                       () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.grace_period.name"), ConfigSettings.GRACE_ENABLED.get()),
        ...
        // Insulation Strength
        this.addDecimalInput("insulation_strength", Side.LEFT, new TranslationTextComponent("cold_sweat.config.insulation_strength.name"),
        ...
        // Smart Hearth
        this.addButton("smart_hearth", Side.RIGHT, () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.smart_source.name", new TranslationTextComponent("block.cold_sweat.hearth_bottom").getString()),
        ...
        // Smart Boiler
        this.addButton("smart_boiler", Side.RIGHT, () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.smart_source.name", new TranslationTextComponent("block.cold_sweat.boiler").getString()),
                                                                            ConfigSettings.SMART_BOILER.get()),
                       button -> ConfigSettings.SMART_BOILER.set(!ConfigSettings.SMART_BOILER.get()),
                       true, false, false, new TranslationTextComponent("cold_sweat.config.smart_source.desc"));

        // Smart Icebox
        this.addButton("smart_icebox", Side.RIGHT, () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.smart_source.name", new TranslationTextComponent("block.cold_sweat.icebox").getString()),
                                                                            ConfigSettings.SMART_ICEBOX.get()),
                       button -> ConfigSettings.SMART_ICEBOX.set(!ConfigSettings.SMART_ICEBOX.get()),
                       true, false, false, new TranslationTextComponent("cold_sweat.config.smart_source.desc"));

        // Source Debug
        this.addButton("source_debug", Side.RIGHT, () -> getToggleButtonText(new TranslationTextComponent("cold_sweat.config.source_debug.name"), ConfigSettings.HEARTH_DEBUG.get()),
