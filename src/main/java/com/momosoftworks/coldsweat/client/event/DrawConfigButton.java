        ...
        if (event.getScreen() instanceof OptionsScreen && ConfigSettings.SHOW_CONFIG_BUTTON.get())
        {
            ...
            if (Minecraft.getInstance().level == null)
            {
                ...
                try
                {
                    ...
                    {   event.getScreen().renderTooltip(poseStack, new TranslatableComponent("tooltip.cold_sweat.config.must_be_in_game").withStyle(ChatFormatting.RED), mouseX, mouseY);
                    });
                }
