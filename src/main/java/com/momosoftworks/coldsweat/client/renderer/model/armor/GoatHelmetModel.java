...
public class GoatHelmetModel<T extends LivingEntity> extends BipedModel<T>
{
	private final ModelRenderer helmet;

	public GoatHelmetModel()
	{
		super(1f);
		texWidth = 64;
		texHeight = 128;
	...
	public GoatHelmetModel<T> withModelBase(BipedModel<?> modelBase)
	{
