...
{
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(ColdSweat.MOD_ID, "hoglin_boots"), "main");
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        PartDefinition right_boot = right_leg.addOrReplaceChild("right_boot", CubeListBuilder.create()
                .texOffs(40, 96).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F,
        ...
        PartDefinition left_boot = left_leg.addOrReplaceChild("left_boot", CubeListBuilder.create()
                .texOffs(40, 96).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F,
