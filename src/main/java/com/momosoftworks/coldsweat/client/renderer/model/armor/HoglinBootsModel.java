...
public class HoglinBootsModel<T extends LivingEntity> extends BipedModel<T>
{
	private final ModelRenderer rightBoot;
	private final ModelRenderer leftBoot;

	public HoglinBootsModel()
	{
		super(1f);
		texWidth = 64;
		texHeight = 128;
	...
	public HoglinBootsModel<T> withModelBase(BipedModel<?> modelBase)
	{
