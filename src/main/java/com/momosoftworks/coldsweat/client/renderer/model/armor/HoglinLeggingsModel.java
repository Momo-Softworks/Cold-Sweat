...
public class HoglinLeggingsModel<T extends LivingEntity> extends BipedModel<T>
{
	private final ModelRenderer waist;
	private final ModelRenderer rightLegging;
	private final ModelRenderer leftLegging;

	public HoglinLeggingsModel()
	{
		super(1f);
		texWidth = 64;
		texHeight = 128;
	...
	public HoglinLeggingsModel<T> withModelBase(BipedModel<?> modelBase)
	{
