package dev.momosoftworks.coldsweat.client.renderer.model.entity;

import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import dev.momosoftworks.coldsweat.ColdSweat;
import dev.momosoftworks.coldsweat.client.renderer.ChameleonAnimations;
import dev.momosoftworks.coldsweat.client.renderer.entity.ChameleonEntityRenderer;
...
import dev.momosoftworks.coldsweat.util.registries.ModEntities;
...
public class ChameleonModel<T extends Chameleon> extends EntityModel<T>
{
	...
	public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha, boolean isOverlay)
	{
		...
		{
			if (CSMath.withinRange(tickCount - hurtTime, 10, 120) && hurtTime != 0)
