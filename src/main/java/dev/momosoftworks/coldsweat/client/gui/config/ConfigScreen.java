...
import dev.momosoftworks.coldsweat.client.gui.config.pages.ConfigPageTwo;
import dev.momosoftworks.coldsweat.core.network.message.SyncConfigSettingsMessage;
