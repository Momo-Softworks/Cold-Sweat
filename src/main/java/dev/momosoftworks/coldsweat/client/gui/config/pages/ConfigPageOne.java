package dev.momosoftworks.coldsweat.client.gui.config.pages;

import dev.momosoftworks.coldsweat.api.util.Temperature;
import dev.momosoftworks.coldsweat.client.gui.Overlays;
import dev.momosoftworks.coldsweat.client.gui.config.AbstractConfigPage;
import dev.momosoftworks.coldsweat.client.gui.config.ConfigScreen;
