package dev.momosoftworks.coldsweat.api.util;

import dev.momosoftworks.coldsweat.ColdSweat;
import dev.momosoftworks.coldsweat.api.event.common.TempModifierEvent;
import dev.momosoftworks.coldsweat.api.registry.TempModifierRegistry;
import dev.momosoftworks.coldsweat.api.temperature.modifier.BiomeTempModifier;
import dev.momosoftworks.coldsweat.api.temperature.modifier.BlockTempModifier;
import dev.momosoftworks.coldsweat.api.temperature.modifier.UndergroundTempModifier;
import dev.momosoftworks.coldsweat.api.temperature.modifier.TempModifier;
import dev.momosoftworks.coldsweat.common.capability.EntityTempManager;
import dev.momosoftworks.coldsweat.common.capability.ITemperatureCap;
import dev.momosoftworks.coldsweat.common.capability.PlayerTempCap;
import dev.momosoftworks.coldsweat.core.network.ColdSweatPacketHandler;
import dev.momosoftworks.coldsweat.core.network.message.TempModifiersSyncMessage;
import dev.momosoftworks.coldsweat.core.network.message.TemperatureSyncMessage;
import dev.momosoftworks.coldsweat.util.compat.CompatManager;
import dev.momosoftworks.coldsweat.util.math.CSMath;
import dev.momosoftworks.coldsweat.util.math.InterruptableStreamer;
import dev.momosoftworks.coldsweat.util.serialization.ListBuilder;
