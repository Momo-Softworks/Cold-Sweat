...
public abstract class TempModifier
{
    ...
    /**
     * Posts this TempModifier's {@link #calculate(LivingEntity, dev.momosoftworks.coldsweat.api.util.Temperature.Type)} to the Forge event bus.<br>
     * Returns the stored value if this TempModifier has a tickRate set, and it is not the right tick.<br>
     * <br>
     * @param temp the Temperature being fed into the {@link #calculate(LivingEntity, dev.momosoftworks.coldsweat.api.util.Temperature.Type)} method.
