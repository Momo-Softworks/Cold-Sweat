            ...
            if (inventoryScreen.getSlotUnderMouse() != null && inventoryScreen.getSlotUnderMouse().getItem().getItem() == ModItems.HELLSPRING_LAMP)
            {
                ...
                if (!inventoryScreen.getMenu().getCarried().isEmpty())
                {
                    if (fuelValue > 0)
                    {
                        ...
                        event.getScreen().blit(ms, slotX - 7, slotY - 12, 0, 0, 0, 30, 8, 8, 30);
                        ...
                        event.getScreen().blit(ms, slotX - 7, slotY - 12, 0, 0, 0, Math.min(30, (int) ((fuel + fuelValue) / 2.1333f)), 8, 8, 30);
                        RenderSystem.setShaderColor(1.0F, 1.0F, 1.0F, 1f);
                        RenderSystem.setShaderTexture(0, new ResourceLocation("cold_sweat:textures/gui/screen/soulfire_lamp_fuel.png"));
                        event.getScreen().blit(ms, slotX - 7, slotY - 12, 0, 0, 0, (int) (fuel / 2.1333f), 8, 8, 30);
                    }
                }
                else
                {
                    ...
                    RenderSystem.setShaderTexture(0, new ResourceLocation("cold_sweat:textures/gui/screen/soulfire_lamp_fuel_empty.png"));
                    event.getScreen().blit(ms, mouseX + 12, mouseY, 0, 0, 0, 30, 8, 8, 30);
                    RenderSystem.setShaderTexture(0, new ResourceLocation("cold_sweat:textures/gui/screen/soulfire_lamp_fuel.png"));
                    event.getScreen().blit(ms, mouseX + 12, mouseY, 0, 0, 0, (int) (fuel / 2.1333f), 8, 8, 30);
                }
            }
        }
    }
