...
public class ModItems
{
    ...
    public static final Item GOAT_FUR = ItemInit.FUR.get();
    ...
    public static final Item GOAT_FUR_CAP = ItemInit.FUR_CAP.get();
    public static final Item GOAT_FUR_PARKA = ItemInit.FUR_PARKA.get();
    public static final Item GOAT_FUR_PANTS = ItemInit.FUR_PANTS.get();
    public static final Item GOAT_FUR_BOOTS = ItemInit.FUR_BOOTS.get();
}