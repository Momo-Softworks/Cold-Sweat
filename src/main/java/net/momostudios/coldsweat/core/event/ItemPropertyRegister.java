...
import net.momostudios.coldsweat.client.itemproperties.NetherbrineLampOverride;
...
public class ItemPropertyRegister
{
    ...
    {
        ItemModelsProperties.registerProperty(ModItems.SOULFIRE_LAMP, new ResourceLocation("cold_sweat:soulfire_state"), new NetherbrineLampOverride());
