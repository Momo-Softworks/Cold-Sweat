...
import net.momostudios.coldsweat.common.item.NethernileLampItem;
...
public class ItemInit
{
    ...
    public static final RegistryObject<Item> SOULFIRE_LAMP_REGISTRY = ITEMS.register("nethernile_lamp", NethernileLampItem::new);
