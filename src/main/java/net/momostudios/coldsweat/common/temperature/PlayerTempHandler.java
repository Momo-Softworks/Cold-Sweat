...
public class PlayerTempHandler
{
    ...
    public static List<TempModifier> getRateModifiers(PlayerEntity player)
    {
        return ListNBTHelper.asList(ListNBTHelper.createIfNull("rate_temp_modifiers", player), TempModifier.class);
    }
}
